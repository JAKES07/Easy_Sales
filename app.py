...
# ============================================================
#
# Local Pydroid development still works normally.
# When EASY_SALES_ENV=production is set by the hosting provider,
# a real secret key is required and HTTPS cookie settings are enabled.
#
